...
# even though b1 and b3 have the same data, comparing them shows up as False
# because python is not comparing the data, but seeing that 
# they are two different objects in memory, so they are not the same in memory
# print(b1 == b2)
# print(b1 == b3)
# print(b1 == 42)
